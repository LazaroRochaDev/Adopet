...
//          catsSex = itemView.findViewById(R.id.tv_pet_sex);
    ...
    private class CatsAdapter extends RecyclerView.Adapter<CatHolder>{
        ...
        public CatHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            return new CatHolder(getLayoutInflater().inflate(R.layout.pet_item, parent, false));
        }
    ...
    private void fillCatsList() {
        Cat cat0 = new Cat("Baki", "Marrom", "Macho", 4);
        ...
        catsList.add(cat0);
        Cat cat1 = new Cat("Bob", "Preto", "Macho", 4);
        ...
        catsList.add(cat1);
        Cat cat2 = new Cat("Pipoca", "Caramelo", "Fêmea", 0);
        ...
        catsList.add(cat2);
        Cat cat3 = new Cat("Biscoito", "Caramelo e branco", "Macho", 1);
        ...
        catsList.add(cat3);
        Cat cat4 = new Cat("Peludo", "Preto e branco", "Macho", 0);
        ...
        catsList.add(cat4);
        Cat cat5 = new Cat("Tico", "Preto e caramelo", "Macho", 0);
        ...
        catsList.add(cat5);
        Cat cat6 = new Cat("Teco", "Marrom escuro", "Macho", 4);
        ...
        catsList.add(cat6);
        Cat cat7 = new Cat("Java", "Branco e caramelo", "Fêmea", 0);
        ...
        catsList.add(cat7);
        Cat cat8 = new Cat("Joãozin", "Preto e marrom", "Macho", 6);
        ...
        catsList.add(cat8);
        Cat cat9 = new Cat("Tião", "Preto e caramelo", "Macho", 1);
        ...
        catsList.add(cat9);
        Cat cat10 = new Cat("Bela", "Caramelo", "Fêmea", 0);
        ...
        catsList.add(cat10);
        Cat cat11 = new Cat("Pluto", "Cinza e branco", "Macho", 2);
        ...
        catsList.add(cat11);
        Cat cat12 = new Cat("Formiga", "Caramelo e branco", "Fêmea", 2);
        ...
        catsList.add(cat12);
        Cat cat13 = new Cat("Robinho", "Preto", "Macho", 3);
        ...
        catsList.add(cat13);
        Cat cat14 = new Cat("Penelope", "Caramelo", "Fêmea", 0);
        ...
        catsList.add(cat14);
        Cat cat15 = new Cat("Cocada", "Caramelo", "Macho", 2);
        ...
        catsList.add(cat15);
        Cat cat16 = new Cat("Dafine", "Caramelo", "Fêmea", 0);
        ...
        catsList.add(cat16);
        Cat cat17 = new Cat("Fifi", "Caramelo e preto", "Fêmea", 1);
        ...
        catsList.add(cat17);
        Cat cat18 = new Cat("Katara", "Marrom e branco", "Fêmea", 6);
